import { isTextFieldEntryEdited, TextFieldEntry, isFeelEntryEdited, FeelEntry, isSelectEntryEdited, SelectEntry, ListGroup, isTextAreaEntryEdited, TextAreaEntry, isCheckboxEntryEdited, CheckboxEntry, Group } from '@bpmn-io/properties-panel';
