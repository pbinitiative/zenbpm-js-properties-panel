...
import { ZenBpmPropertiesProviderModule } from '../lib';
...
/**
 * Convenience bootstrap that wires the ZenBPM properties provider on top of the
 * bpmn-js-properties-panel base panel + zenbpm moddle extension.
 */
export function bootstrapZenBpmPropertiesPanel(diagram, options = {}) {
  const modules = [
    CoreModule,
    SelectionModule,
    ModelingModule,
  ...
  return bootstrapPropertiesPanel(diagram, {
    modules,
    moddleExtensions,
    debounceInput: false,
    ...options
